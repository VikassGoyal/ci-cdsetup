...
//   Future<Future> getThumbByteData(int? width, int? height, {int? quality = 100}) async {
//     if (width! < 0) {
...
//     Completer completer = Completer<ByteData>();
...
//   /// later again, without need to call this method again.
//   Future<Future> getByteData({int? quality = 100}) async {
//     if (quality! < 0 || quality > 100) {
//       throw ArgumentError.value(quality, 'quality should be in range 0-100');
//     }
...
//   )
//   Future<Future> requestOriginal({int? quality = 100}) {
...
//   )
//   Future<dynamic> requestThumbnail(
//     int? width,
//     int? height, {
//     int? quality = 100,
//   }) async {
