      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              "When You create a user profile in the Services and confirm being the holder of a certain number, CONET will collect the information provided by You. In order to create a user profile, You must register Your first name, last name and phone number. Additional information that may be provided at Your option include, but is not limited to, photo, gender, street address and zip code, country of residence, email address, work information, professional website, Facebook page, Twitter address, work tagwords and a short status message. CONET may supplement the information provided by You with information from third parties and add it to the information provided by You e.g. demographic information and additional contact information that is publicly available.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "Where the CONET mobile applications (“CONET Apps”) are obtained from other sources than Apple App Store or Google Play, You may share the names, numbers, Google ID’s and email addresses contained in Your address book (“Contact Information”) with CONET by enabling the CONET Enhanced Search Functionality. Where the CONET Apps are obtained from Apple App Store or Google Play, we do not share any user Contact Information. In addition to Contact Information, if You choose to activate use of a third party service, such as social networks services, within the Services, CONET may collect, store and use the list of identifiers associated with said services linked to the Contact Information in order to enhance the results shared with other Users.\n\n\nPlease note that no other contact information other than the phone numbers and thereto attached names, Google ID’s and email addresses will be collected and used from Your address book. Other numbers or information that may be contained in Your address book will be filtered away by our safety algorithms and will therefore not be collected by CONET. Please also note that You can always choose not to share Contact Information with CONET and if You have shared such information and changed Your mind, You can delist Your number or opt-out to render Your entire Contact Information unavailable for search in the CONET database.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "You may provide us with various information in connection with Your interaction with our Services. For example, You may through tagging functionality associate a phone number, that is not registered in the CONET database or belongs to a User,\n\nwith a business or name and You may report a phone number as spam or some other attribute to be included in spam blocking directories. CONET may also from time to time offer You the opportunity to provide information on Your experience from using the Services or to participate in contests, surveys or other promotions. CONET will collect the information You provide in connection therewith, as well as any other information You provide through the Services or when You communicate or interact with us.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "CONET may use the personal information collected to provide, maintain, improve, analyze and personalize the Services to its Users, partners and third party providers. More specifically, CONET may use such information to:\n\na. provide smart caller ID, dialer and messaging functionality that, among other features, allow for population of unidentified numbers and other data in call or message logs, display the name associated with a certain number for incoming or outgoing calls and messages or following a manual number search against the CONET database;\n\nb. display the number associated with a certain name following a manual name search against the CONET database, subject to that name searches will only produce a number linked to the name if the number is available for search in a public database or relates to a User who has made his or her name available for search, provide Your information to the person You reach out to when requesting a contact via the CONET name search service, in which case Your request will be forwarded to that person via an SMS and he/she may choose whether or not to share the phone number with You at his/her own discretion;\n\nc. display information based on connections a User may have in common, directly or indirectly, with other Users via a “social graph” algorithm, display the “who viewed my profile” and “availability” functionalities of the Services;\n\nd. send in application push notifications and reminders and deliver messages via the Services, in which case Your messages will be kept for a limited period of time in order to deliver the messages but CONET will not, unless specifically stated, monitor the content of Your messages;\n\ne. maintain User spam lists and build a community based spam blocking directory;\n\nf. enable You to use and share Your information in connection with Your registration, login or other use of third party services e.g. payment service providers, online services, social networking sites and other third party API’s; and\n\ng. otherwise improve our Services, business and operations.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "We may use any of the information collected, as set out above, to provide You with location and interest based advertising, marketing messaging, information and services. We may also use the collected information to measure the performance of our advertising and marketing services.\n\nWe may contact You for verification purposes or with information pertaining to the Services or special offers, e.g. newsletter e-mails, SMS and similar notifications about CONET’s and our business partners’ products and services. We also use the collected information to respond to you when you contact us.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "We may use the collected information to comply with applicable laws and to enforce our agreements and protect and defend the rights or safety of CONET, its Users or any other person and verify provided User profile information with third party providers and ensure technical service functionality and data accuracy, perform trouble-shooting and prevent or detect fraud, security breaches or illegal activities.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "If a User chooses to disable the Enhanced Search Functionality, the Contact Information made available by that User is disabled and will thereafter not be available for search in the CONET database. If any persons do not wish to have their names and phone numbers made available through the Enhanced Search or Name Search functionalities, they can exclude themselves from further queries by notifying CONET via its website at www.CONETAPP.in or as set forth in the contact details below. You acknowledge and agree that CONET may keep and process personal information related to such request in order to be able to honor the request.\n\nYou can limit or opt-out of the collection and use of Your information for ad targeting by third parties via Your device settings.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "In order to provide the Services, CONET will transfer, process and store personal information in a number of countries, including but not limited to India, and may also use cloud based services for this purpose. CONET may also subcontract storage or processing of Your information to third parties located in countries other than Your home country. Information collected within one country may, for example, be transferred to and processed in another country, which may not provide the same level of protection for personal data as the country in which it was collected. You acknowledge and agree that CONET may transfer Your personal information as described above for purposes consistent with this Privacy Policy. We take all reasonable precautions to protect personal information from misuse, loss and unauthorized access. CONET has implemented physical, electronic, and procedural safeguards in order to protect the information, including that the information will be stored on secured servers and protected by secured networks to which access is limited to a few authorized employees and personnel. However, no method of transmission over the Internet or method of electronic storage is 100% secure.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "CONET may on its own initiative, or at Your request, replenish, rectify or erase any incomplete, inaccurate or outdated personal information retained by CONET in connection with the operation of the Services. When required by applicable law, You have the right to know what personal information is stored about You and to have any such information corrected or deleted on Your request. See contact details below.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
            ...
            const SizedBox(height: 10),
            Text(
              "Services are not intended for or designed to attract anyone under the relevant age of consent to enter into binding legal contracts under the laws of their respective jurisdictions. CONET does not intentionally or knowingly collect personal information through the Services from anyone under that age. We encourage parents and guardians to be involved in the online activities of their children to ensure that no personal information is collected from a child without their consent.",
              style: Theme.of(context)
                  .textTheme
                  .bodyText1
                  ?.apply(color: AppColor.whiteColor),
